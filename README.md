...
## Usage
1.  **Download the dataset**: Obtain the `creditcard.csv` file from the [Kaggle Credit Card Fraud Detection](https://www.kaggle.com/datasets/mlg-gza/creditcardfraud) dataset and place it in the `/content/` directory of your Colab environment.
